...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |086 - Editor-Improvement|) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "testing.rkt" "teachpack" "htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "testing.rkt" "teachpack" "htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp")) #f)))
...
;; function edit so that it ignores a keystroke if adding it to the end of
;; the pre field would mean the tendered text is too wide for your canvas.
...
(define canvas (image-width scene))
...
(define (edit e ke)
  (cond
    ...
    [(string=? "\t" ke) e]
    [(= (string-length ke) 1)
     (if (< (image-width (draw-text (add-letter e ke))) canvas)
         (add-letter e ke)
         e)]
    [else e]))
