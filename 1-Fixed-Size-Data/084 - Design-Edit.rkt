...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |084 - Design-Edit|) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "testing.rkt" "teachpack" "htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "testing.rkt" "teachpack" "htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp")) #f)))



;; Design edit. The function consumes two inputs, an editor ed and a KeyEvent ke,
;; and it produces another editor. Its task is to add a single-character KeyEvent ke
...
;; "left" and "right". The left arrow moves the cursor one character to
;; the left (if any), and the right arrow moves it one character to the right
...
;; When we solved this exercise, we created 20 examples and turned all of them
;; into tests.
...
(check-expect (string-remove-last "o") "o")
(define (string-remove-last s)
  (if (> (string-length s) 1) (substring s 0 (- (string-length s) 1)) s))
